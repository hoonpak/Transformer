    ...
    def forward(self, x, masked_info, pad_mask):
        ...
        **INPUT SHAPE**
        ...
        for enc_layer in self.encoder_layers:
            output = enc_layer(x=output, masked_info=masked_info, pad_mask=pad_mask)
        return output
    ...
    def forward(self, x, src_tgt_masked_info, tgt_masked_info, pad_mask, encoder_output):
        ...
        **INPUT SHAPE**
        ...
        for dec_layer in self.decoder_layers:
            output = dec_layer(x=output, src_tgt_masked_info=src_tgt_masked_info, tgt_masked_info=tgt_masked_info, pad_mask=pad_mask, encoder_output=encoder_output)
        return output
